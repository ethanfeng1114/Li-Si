...
def get_parameter_values():
    ...
    return {
        ...
        "Electrode height [m]": 0.014, #Supplementary material
        "Electrode width [m]": 0.014, #Supplementary material
        ...
        "Primary: Initial concentration in negative electrode [mol.m-3]": 0.5*27700.0, #init at 50% ish
        ...
        "Primary: Negative electrode exchange-current density [A.m-2]": 0, #Graphite electrochemically inactive
        "Primary: Negative electrode density [kg.m-3]": 2255,
        ...
        "Secondary: Initial concentration in negative electrode [mol.m-3]": 0.5 * 276610.0, #init at 50%
        ...
        "Electrolyte diffusivity [m2.s-1]": salt_diffusivity_Durdel2023,
